                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="walikelas.php" class="text-decoration-none">
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            ...
                                            <div class="col-auto">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-person-workspace" viewBox="0 0 16 16">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="guru_pelajaran.php" class="text-decoration-none">
                ...
                <div class="container-fluid mt-4">
                    <div class="row">
                        <div class="col-12 text-left">
                            <img src="gru.png" alt="Desain" class="img-fluid" style="max-width: 100%; height: auto;">
                        </div>
                    </div>
                </div>
