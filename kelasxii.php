        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">DAFTAR KELAS XII</h1>
...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="xiipplg1.php" class="text-decoration-none">
        ...
        <!-- Card X PPLG 2 -->
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="xiipplg2.php" class="text-decoration-none">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
        ...
        <!-- Card X AKL 1 -->
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="xiiakl1.php" class="text-decoration-none">
        ...
        <!-- Card X AKL 2 -->
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="xiiakl2.php" class="text-decoration-none">
                <div class="card border-left-secondary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
        ...
        <!-- Card X MPLB 1 -->
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="xiimplb1.php" class="text-decoration-none">
        ...
        <!-- Card X MPLB 2 -->
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="xiimplb2.php" class="text-decoration-none">
                <div class="card border-left-danger shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
        ...
        <!-- Card X PM 1 -->
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="xiipm1.php" class="text-decoration-none">
        ...
        <!-- Card X PM 2 -->
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="xiipm2.php" class="text-decoration-none">
                <div class="card border-left-dark shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
