                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="kelas10.php" class="text-decoration-none">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="kelas11.php" class="text-decoration-none">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <a href="kelas12.php" class="text-decoration-none">
                ...
                <div class="container-fluid mt-4">
                    <div class="row">
                        <div class="col-12 text-center">
                            <img src="sw.webp" alt="Desain" class="img-fluid" style="max-width: 100%; height: auto;">
                        </div>
                    </div>
                </div>
